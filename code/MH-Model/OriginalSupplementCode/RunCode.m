...
AccumulationRate = .25*(1-phi0); % original = 0.25 % accumulation rate
Qbar = -0.707; % original = -0.5 % surface energy flux
type = 'empirical'; %original = empirical
% % % % % % % % % % % % % % % % % % % % % % % % % % %
...
% Initial values
Rbar = 0; % fixed surface water flux (rain)
